...
<div class="container-fluid">
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-lg-center py-3 flex-column flex-lg-row">
            <h2 class="h5 mb-3 mb-lg-0">Atualizar Cliente</h2>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <!-- Basic information -->
                <div class="card mb-4">
                    <form id="login-form" class="form" action="<?= url_to('update_client_submit') ?>" method="post">
                        <div class="card-body">
                            ...
                            <div class="hstack gap-3">
                                ...
                                <button class="btn btn-primary btn-sm btn-icon-text"><i class="bi bi-save"></i> <span class="text">Atualizar</span></button>
                            </div>
                            ...
                            <div class="mt-5 row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nome" class="form-control" value="<?= $client['nome'] ?>" required>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="tel" name="telefone" class="form-control" value="<?= $client['telefone'] ?>" required>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="endereco" id="endereco_cep" class="form-control" value="<?= $client['cep'] ?>" required>
